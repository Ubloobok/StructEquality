...
namespace StructEquality.Domain
{
    ...
    public class EquatableDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        public EquatableDictionary() : this(0) { }
...
//        }
        ...
        {
            // CHANGE: Type from Dictionary to EquatableDictionary.
            ...
            internal Enumerator(EquatableDictionary<TKey, TValue> dictionary, int getEnumeratorRetType)
            {
        ...
        public sealed class KeyCollection : ICollection<TKey>, ICollection, IReadOnlyCollection<TKey>
        {
            ...
            public KeyCollection(EquatableDictionary<TKey, TValue> dictionary)
            {
                if (dictionary == null)
                {
                    ThrowHelper.ThrowArgumentNullException(ExceptionArgument.dictionary);
            ...
            public struct Enumerator : IEnumerator<TKey>, System.Collections.IEnumerator
            {
                ...
                internal Enumerator(EquatableDictionary<TKey, TValue> dictionary)
                {
                    this.dictionary = dictionary;
                    version = dictionary.version;
                    index = 0;
        ...
        public sealed class ValueCollection : ICollection<TValue>, ICollection, IReadOnlyCollection<TValue>
        {
            ...
            public ValueCollection(EquatableDictionary<TKey, TValue> dictionary)
            {
                if (dictionary == null)
                {
                    ThrowHelper.ThrowArgumentNullException(ExceptionArgument.dictionary);
